/* NuttX system-hardware boundary for the authority AON PMU HAL.  These are
 * direct, unmodified imports of the BK7258 generated SYS register, structure
 * and LL headers.  Neighboring soc/soc.h and hal_port.h supply only the NuttX
 * address/read-write and logging integration interfaces. */
