...
#define BK7258_SYS_ANALOG_BASE   (BK7258_SYS_BASE + UINT32_C(0x100))
#define BK7258_SYS_ANALOG_STATE  (BK7258_SYS_BASE + UINT32_C(0x0e8))
#define BK7258_SYS_ANALOG_STATE_SHIFT 0
#define BK7258_AON_PMU_R41       (BK7258_AON_PMU_BASE + UINT32_C(0x104))
#define BK7258_AON_PMU_R41_LPO_CONFIG_MASK UINT32_C(0x3)
#define BK7258_AON_RTC_COUNTER_LO (BK7258_AON_RTC_BASE + UINT32_C(0x00c))
#define BK7258_AON_RTC_COUNTER_HI (BK7258_AON_RTC_BASE + UINT32_C(0x028))
#define BK7258_FLASH_CTRL_OP_CTRL (BK7258_FLASH_CTRL_BASE + UINT32_C(0x10))
#define BK7258_FLASH_CTRL_DATA_FLASH_SW (BK7258_FLASH_CTRL_BASE + UINT32_C(0x18))
#define BK7258_FLASH_CTRL_RD_FLASH_ID (BK7258_FLASH_CTRL_BASE + UINT32_C(0x20))
#define BK7258_FLASH_CTRL_OP_CMD  (BK7258_FLASH_CTRL_BASE + UINT32_C(0x54))
...
#define BK7258_SYS_SADC_CLK_EN    (UINT32_C(1) << 5)
...
#define BK7258_SYS_SADC_CLK_DCO   (UINT32_C(1) << 17)
#define BK7258_SYS_SADC_INT_EN    (UINT32_C(1) << 8)
#define BK7258_SYS_MAC_CKEN       (UINT32_C(1) << 26)
#define BK7258_SYS_PHY_CKEN       (UINT32_C(1) << 27)
 ...
 * powered down, which left the MAC state machine at 0 for every scan. */
#define BK7258_SYS_OFDM_POWERDOWN (UINT32_C(1) << 13)
