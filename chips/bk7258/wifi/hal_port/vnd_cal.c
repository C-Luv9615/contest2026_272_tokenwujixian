...
/* GPIO_28=28 GPIO_26=26 (Armino hal_gpio_types.h enum order, 0-based) */
...
const TXPWR_ST gtxpwr_tab_def_polar_ble[BLE_2_4_G_CHANNEL_NUM] = {
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),  // ch0 2402  inused
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),  // ch1 2404
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),  // ch4 2410
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    ...
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),  // ch14 2430
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_INUSED),  // ch19 2440 inused
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),  // ch24 2450
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),  // ch29 2460
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),  // ch34 2470
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),
    INIT_TXPWR_VALUE(23, TXPWR_ELEM_UNUSED),  // ch39 2480 inused
};
/****************************** temperature table  ****************************/
...
#else
    vnd_cal_set_epa_config(0, 28, 26, pwr_gain_base_gain_b, pwr_gain_base_gain_g);
#endif
