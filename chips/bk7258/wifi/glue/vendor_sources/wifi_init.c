 ...
 * instrumentation; see glue/include/bk7258_initseq.h for the rationale and the
 * full removal recipe.
 *
 ...
 * ----------------------------------------------------------
 * third_party/beken_armino/glue/bk_wifi/src/wifi_init.c is byte-identical to
 ...
 * by name (glue/rtos_compat_shim.c).
 */
...
#include "../../third_party/beken_armino/glue/bk_wifi/src/wifi_init.c"
